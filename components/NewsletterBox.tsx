...
export default function NewsletterBox() {
  return (
    <Flex overflow='hidden' pos='relative' flexDir='column' align='center' maxWidth='3xl' paddingX='14' paddingY='20' color='white' border='2px' rounded='2xl' textAlign='center' bgColor='green.500'>
      ...
      <Flex pos='relative' align='center' minWidth='md' maxWidth='lg' marginTop='6'>
        <Input placeholder='Enter your email' outline='0' minHeight='12' border='2px' borderColor='gray.300' _placeholder={{ color: 'gray.200' }} focusBorderColor='gray.300' />
