      ...
      <VStack>
        <Flex maxW={"800px"} flexDir={"column"} alignItems={'center'} textAlign={'center'} pt="16" px='4'>
          <Stack direction={['column', 'row']} justify={'center'} color="gray.700">
            <Heading lineHeight='1' fontSize={['7xl', '5xl']} fontWeight={'extrabold'}>Collect.</Heading>
            ...
            <Heading lineHeight='1' fontSize={['7xl', '5xl']} fontWeight={'extrabold'}>Share.</Heading>
          </Stack>
